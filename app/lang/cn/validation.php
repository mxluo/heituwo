...
return array(
    ...
    */
    ...
    'attributes' => array(
                    ...
                    'email'            => '<span class="badge badge-info bg-blue">邮箱</span>',
                    'password'         => '<span class="badge badge-info">密码</span>',
                    'repassword'       => '<span class="badge badge-info">确认密码</span>',
                    'tel'              => '<span class="badge badge-info bg-blue">电话</span>',
                    'slug'             => '<span class="badge badge-info">别名</span>',
                    'category'         => '<span class="badge badge-info">分类</span>',
                    'img'              => '<span class="badge badge-info">图片</span>',
                    'title'            => '<span class="badge badge-info">标题</span>',
                    'images'           => '<span class="badge badge-info">图片</span>',
                    'desc'             => '<span class="badge badge-info">描述</span>',
                    'job'              => '<span class="badge badge-info">职位名称</span>',
                    'content'          => '<span class="badge badge-info">内容</span>',
                    'num'              => '<span class="badge badge-info">数量</span>',
                    'cname'            => '<span class="badge badge-info bg-blue">姓名</span>',
                    'industry'         => '<span class="badge badge-info bg-blue">行业</span>',
                    'specialty'       => '<span class="badge badge-info bg-blue">专业</span>',
                    'client_name'     => '<span class="badge badge-info bg-blue">客户名称</span>',
                    'service_content' => '<span class="badge badge-info bg-blue">服务内容</span>',
                ),
