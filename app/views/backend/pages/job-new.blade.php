...
@section('page_title')
<h1>添加招聘 <a href="{{url('/admin/job/all')}}" class="btn btn-info">招聘列表</a></h1>
@endsection
@section('content')
      <div class="row">
        <form action="{{url('/admin/job/create')}}" method="post" accept-charset="utf-8" class="form-horizontal">
          
          <div class="col-md-12 form-group">
            <label class="col-md-1 control-label">职位名称: </label>
            <div class="col-md-7">
              <input type="text" class="form-control " name="job" value="" placeholder="职位名称"><br>
            </div>
            <div class="col-md-4">
            </div>
          </div>
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-7">
              <input type="text" class="form-control " name="ejob" value="" placeholder="Job Title"><br>
            </div>
            <div class="col-md-4">
            </div>
          </div>
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-3">
              <input type="text" class="form-control " name="num" value="" placeholder="输入阿拉伯数字"><br>
            </div>
            <label class="col-md-1 control-label">工作地点: </label>
            <div class="col-md-3">
              <input type="text" class="form-control " name="place" value="" placeholder="工作地点"><br>
            </div>
          </div>
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-7">
              <script id="myEditor1" name="duty" type="text/plain" style="width:100%;height:200px;"></script>
            </div>
            <div class="col-md-4">
            </div>
          </div>
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-7">
              <script id="myEditor2" name="ask" type="text/plain" style="width:100%;height:200px;"></script>
            </div>
            <div class="col-md-4">
            </div>
          </div>
